...
def run(model, Dataset, log_path, plotter, CHECKPOINT_tempfile):
    ...
    train_data_src = "data\\train_blur\\train\\train_blur\\"
    train_data_tgt = "data\\train_sharp\\train\\train_sharp\\"
    ...
    train_transform_tgt = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
    train_set = Dataset(train_data_src, train_data_tgt, train_transform_src, train_transform_tgt)
